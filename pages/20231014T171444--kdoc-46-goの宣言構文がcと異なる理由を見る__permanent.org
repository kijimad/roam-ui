...
- 参照: [[id:20231014T191829][KDOC 47: 『低レイヤを知りたい人のためのCコンパイラ作成入門』]]。Cからの改良点としてGoの型記法が挙げられていた
- 参照: [[https://qiita.com/hachi8833/items/7c43a93130fcce3e308f][[翻訳]Go言語の構文がC言語から大胆に変わった理由 - Qiita]]。ロブ・パイクの解説
- 類推: 過去の方法の問題点を把握することで、現在の決定が理解できるものはほかにあるか
