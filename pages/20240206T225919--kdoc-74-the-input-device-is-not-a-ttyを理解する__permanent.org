...
* 関連
- 参照: [[https://ohbarye.hatenablog.jp/entry/2019/05/05/learn-tty-with-docker][docker run -it で学ぶ tty とか標準入出力とかファイルディスクリプタとか - valid,invalid]]。[[id:1658782a-d331-464b-9fd7-1f8233b8b7f8][Docker]]で検証するのが参考になる
- 追加調査: TTYが何かあまりわからない
