...
* 関連
- 具体例: [[id:20231014T125935][KDOC 45: プログラミング言語の内部的な違いをアセンブリから調べる]]。アセンブリを見て確認する具体例
- 動機: [[id:20240427T182744][KDOC 142: データセグメントの使い分けを試す]]。いくつかの型の値を入れて試してみたときに、そういえば知らなかったと考えた
