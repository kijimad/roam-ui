...
* 関連
- 動機: [[id:20241017T190613][KDOC 254: ジョブプロセスがSleepしていた理由を考える]]。調べたきっかけとなる事象
- 補足: [[id:20240225T174224][KDOC 109: 発行システムコールを調べる]]。straceで詳細に調べる方法
- 補足: [[id:20241102T103338][KDOC 260: プロセスがSleepになるのを再現する]]。の、より的確な再現
