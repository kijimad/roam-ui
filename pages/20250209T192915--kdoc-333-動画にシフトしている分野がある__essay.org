...
YouTubeにあった詳細な解説動画シリーズを発見してすべて観た。複雑さを抑えて単純に保つための方法(バス方式)が理解できた。さらに便利なショートカット、数量計算の考え方などを知った。1話30分で30話あるから、大変な分量だった。説明されれば理解するのは難しくないが、自分で発見したり編み出すのは難しい。
