...
- 参照: [[https://syntactic-sugar.dev/blog/nested-route/go-escape-analysis][Stack or Heap? Going Deeper with Escape Analysis in Go for Better Performance]]。調べている中でio.Readerとio.Writerインターフェースの設計について言及していたのを見つけた
- 動機: [[id:20250701T193212][KDOC 414: インターフェースがヒープにエスケープされるのを見る]]。調べるきっかけになった
