...
* Git LFS
100MBを超えるファイルを[[id:6b889822-21f1-4a3e-9755-e3ca52fa0bc4][GitHub]]にpushしたくなったので、Git LFSを使ってみた。デフォルトでは、100MBより大きなファイルが含まれているとgit pushでrejectされるため設定が必要である。最初に少し設定するだけで[[id:90c6b715-9324-46ce-a354-63d09403b066][Git]]コマンドが普通に使えるのに驚いた。
