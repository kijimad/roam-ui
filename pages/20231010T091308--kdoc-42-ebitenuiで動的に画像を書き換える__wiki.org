...
EbitenUIはゲームエンジン[[id:1125139c-d69f-4af0-a564-6b9b399ce976][Ebitengine]]のUIライブラリである。クリックなどのイベントに応じて動的にラベルを切り替える方法がわからなかったので、コードを読んで把握した方法を書く。

結論としては、UIのイベントハンドラに自身のフィールドを書き換える無名関数を登録すればよい。
...
- 類推: ほかに詰まったところ、調べてわからなかったことはないか
