...
- レビュー
  - [X] 2024-02-12 貴島
* 概要
[[id:7cacbaa3-3995-41cf-8b72-58d6e07468b1][Go]]で ~errors.Unwrap()~ がシンプルで美しく見えたので読む。
...
- 参照: [[https://pkg.go.dev/errors#Unwrap][errors package - errors - Go Packages]]を読んだ
- 類推: [[id:20231103T214045][KDOC 53: Goで独自定義のエラーをconstにする]]。Goのエラーを調べるつながり
