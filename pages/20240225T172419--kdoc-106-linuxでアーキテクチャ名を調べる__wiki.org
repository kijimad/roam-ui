...
#+caption: unameシステムコールが発行されている。2>&1はorg-babel用
...
- 動機: [[id:20240105T215847][KDOC 63: 『私はどのようにしてLinuxカーネルを学んだか』]]。を読んで、ここから知ろうと考えた
- 未解決: Linuxカーネルのビルド時に決まるというアーキテクチャ名はどこに保存されているか
