...
というわけで、ブロックサイズを増やすとパフォーマンスが改善するが、それはシステムコール数が減ったからだと考えられる。

* 関連
- 補足: [[id:20240225T174224][KDOC 109: 発行システムコールを調べる]]。straceの使い方
- 検証: [[id:20240601T120632][KDOC 181: 『Linuxシステムプログラミング』]]。例を試した
